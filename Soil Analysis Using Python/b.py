...
#Plot of B variation along LAT and LONG

fig0 = plt.figure(figsize=(20,10))
fig0.canvas.set_window_title('Variation Of B with Latitude and Longitude')
plt.subplots_adjust(hspace = 0.5)
plt.subplot(2, 1, 1)
plt.scatter(X[:,0] , y)
plt.title('Variation of B with Latitude')
plt.xlabel('Latitude')
plt.ylabel('B')

plt.subplot(2, 1, 2)
plt.scatter(X[:,1] , y)
plt.title('Variation of B with Longitude')
...
fig1.canvas.set_window_title('Hyperplane for predicting B')
plt.clf()
