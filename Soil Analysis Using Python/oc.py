...
#Plot of OC variation along LAT and LONG

fig0 = plt.figure(figsize=(20,10))
fig0.canvas.set_window_title('Variation Of OC with Latitude and Longitude')
plt.subplots_adjust(hspace = 0.5)
plt.subplot(2, 1, 1)
plt.scatter(X[:,0] , y)
plt.title('Variation of OC with Latitude')
plt.xlabel('Latitude')
plt.ylabel('OC')

plt.subplot(2, 1, 2)
plt.scatter(X[:,1] , y)
plt.title('Variation of OC with Longitude')
...
fig1.canvas.set_window_title('Hyperplane for predicting OC')
plt.clf()
